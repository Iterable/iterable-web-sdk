...
| handleLinks               | How to open links. If undefined, use browser-default behavior. `open-all-external` opens all in new tab, `open-all-internal` opens all in same tab, `external-new-tab` opens only external links in new tab otherwise same tab. | 'open-all-internal' \| 'open-all-external' \| 'external-new-tab' | undefined |   |
